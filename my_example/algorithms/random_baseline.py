"""Random feasible baseline for satellite task planning."""
import random
...
def random_baseline_task_planning(accessWindows, targetList, satResources, numSatellites, numTargets,
                                  duration=86400.0, seed=42):
    """Randomly shuffle candidate windows and greedily accept feasible tasks."""
    print("\n=== Starting Random Baseline ===")
